...
owid_country = pd.read_csv('rawdata/owid_country_info.csv',
...
imf_ex_im = pd.read_csv("rawdata/imf_import_export_cleaned.csv").dropna()

wb_econ = pd.read_csv("rawdata/world-bank-econ-data.csv") 
...
create_network(imf_und_filter,'2020', 0, 1, 3, 2, 'assets/imf_2020.html')
...
create_network(un_undirect,'export_2020', 4, 5, 3, 2, 'assets/un_2020.html')
